...
import { AnimationFrames, Sprite, Area, TileMap, Player, GameSystem } from './sprite';
import { V2, R } from './sprite';
...
document.querySelectorAll(".tablink").forEach(element => {
  element.addEventListener('click', function () {
    ...
    var canvas: HTMLCanvasElement = document.getElementById('tab' + this.id).querySelector(".game-screen canvas") as HTMLCanvasElement;
...
var active;
var canvas = document.querySelector(".game-screen canvas") as HTMLCanvasElement;
var ctx = canvas.getContext("2d");
var gameLegend = new GameSystem(document.querySelector("#game-legend"), (document.querySelector("#game-legend canvas") as HTMLCanvasElement).getContext("2d"), "#00FF00FF", 30, new Area(new R(0, 0, 100, -100), new V2(0, 0)));
var gameBunker = new GameSystem(document.querySelector("#game-bunker"), (document.querySelector("#game-bunker canvas") as HTMLCanvasElement).getContext("2d"), "#0000BBFF", 30, new Area());
